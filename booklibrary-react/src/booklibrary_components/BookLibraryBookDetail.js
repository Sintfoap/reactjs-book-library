                ...
                <div className="container">
                    ...
                    <div>
                        ...
                        <div style={{ float: "left" }}>
                            <h5>Author: <Link className="btn btn-outline-green Nav_button" to={"/authors/" + String(this.state.book.author)}>{this.state.book.author_obj.last_name}, {this.state.book.author_obj.first_name}</Link></h5>
                            <h5>Genre: <Link className="btn btn-outline-green Nav_button" to={"/genres/" + String(this.state.book.genre)}>{this.state.book.genre_obj.category}</Link></h5>
                            {Object.keys(this.state.book.series_obj).length > 0 &&
                                <div>
                                    <h5>Series: <Link className="btn btn-outline-green Nav_button" to={"/series/" + String(this.state.book.series)}>{this.state.book.series_obj.name}</Link></h5>
